        ...
        <div className="bg-gray-900">
            <div className="max-w-2xl mx-auto text-white py-10">
                ...
                <div className="mt-28 flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-400">
                    <p className="order-2 md:order-1 mt-8 md:mt-0"> &copy; WebCars, 2024. </p>
                    <div className="order-1 md:order-2">
                        <span className="px-2 cursor-pointer">Sobre nós</span>
                        <span className="px-2 border-l cursor-pointer">Contato</span>
                        <span className="px-2 border-l cursor-pointer">Política de Privacidade</span>
                    </div>
                </div>
            </div>
        </div>
